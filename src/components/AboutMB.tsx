...
const AboutMB: React.FC = () => {
  return (
    <div className="min-h-screen relative flex flex-col justify-center items-center overflow-hidden py-16 md:py-24">
      {/* Background Overlay */}
      <div className="absolute inset-0 bg-black opacity-75"></div>

      {/* Content Container */}
      <div className="relative z-10 max-w-4xl mx-auto space-y-12 md:space-y-16 text-white px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-blackops text-center mb-6 md:mb-8 text-cyan-300 thin-glow">
          About MINDBEND
        </h2>
        <p className="text-base sm:text-lg md:text-xl font-bruno leading-relaxed text-center text-gray-200">
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-blackops text-center mb-6 md:mb-8 text-green-300 thin-glow">
          ECOGENESIS
        </h2>
        <p className="text-base sm:text-lg md:text-xl font-bruno leading-relaxed text-center text-gray-200">
